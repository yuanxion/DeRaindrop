...
class Trainer(object):
    ...
    def forward(self, batch, img, gt):
        ...
        loss_g = 0.01 * (-loss_g_bce) + loss_g_atten + loss_g_ms
        ...
        return loss_g, loss_d, loss_g_atten, loss_g_ms, loss_d_map
    ...
    def train(self):
        ...
        for epoch in range(self.epoches):
            for i, (img, gt) in enumerate(self.trainloader):
                ...
                print(
                    '[{}/{}] loss_g:loss_d, loss_g_atten:loss_g_ms, loss_d_map {:.3f}:{:.3f}, {:.3f}:{:.3f}, {:.3f}'.format(
                        i,
                        epoch,
                        loss_g,
                        loss_d,
